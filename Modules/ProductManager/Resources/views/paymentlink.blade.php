           ...
           <div class="col-md-4">
             <div class="cart-dtl-box shad confirm-pay">
               ...
               <ul class="total-block">
                 <li><p>Total Quantity</p> <strong>{{ '1' }}</strong></li>

                 @foreach($productData as $product)

                 @php
                 $total = \App\Helpers\BasicHelpers::offervalue($product->id,$logInedUser->id);
                 @endphp
               ...
               <input type="hidden" name="offer" value="1" class="offerpruchase">
             ...
             <div class="cart-dtl-box shad stripe-block">
               <img src="{{ asset('img/stripe.png') }}" alt="" style="margin:0 0 25px">
       ...
       if(n == 'none'){
        ...
        $.ajax({
            ...
            error: function (xhr, ajaxOptions, thrownError) {
                ...
                $(".showloaderimg").hide();
                $(".returnmessage").html('<p style="color:red">'+obj['message']+'</p>');
