...
<!--        <div class="user-panel">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview <?php echo e(in_array(\Request::route()->getName(), ["admin.users.index"]) ? "active" : ""); ?>">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="<?php echo e(in_array(\Request::route()->getName(), ["admin.users.employee"]) ? "active" : ""); ?>">
                        <a href="<?php echo e(route('admin.users.employee')); ?>"><i class="fa fa-circle-o"></i> Employee User</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="treeview <?php echo e(in_array(\Request::route()->getName(), ["admin.restaurents.index"]) ? "active" : ""); ?>">
                <a href="#">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li class="<?php echo e(in_array(\Request::route()->getName(), ["admin.restaurents.index"]) ? "active" : ""); ?>">
                        <a href="<?php echo e(route('admin.restaurents.index')); ?>"><i class="fa fa-circle-o"></i> Restaurant List</a>
                    </li>
            ...
            <li class="treeview <?php echo e(in_array(\Request::route()->getName(), ["admin.stamps.index"]) ? "active" : ""); ?>">
                <a href="#">
                    <i class="fa fa-list"></i>
                    <span>Stamp Card Manager</span>
                    <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                </a>
                <ul class="treeview-menu">
                    <li class="<?php echo e(in_array(\Request::route()->getName(), ["admin.stamps.index"]) ? "active" : ""); ?>">
                        <a href="<?php echo e(route('admin.stamps.index')); ?>"><i class="fa fa-circle-o"></i> Stamp Cards List</a>
                    </li>

                    <li class="<?php echo e(in_array(\Request::route()->getName(), ["admin.stamps.freecards"]) ? "active" : ""); ?>">
                        <a href="<?php echo e(route('admin.stamps.freecards')); ?>"><i class="fa fa-circle-o"></i> Free Cards To user </a>
                    </li>

                </ul>
            </li>

            <li class="treeview <?php echo e(in_array(\Request::route()->getName(), ["admin.Orders.histroy"]) ? "active" : ""); ?>">
                <a href="#">
                    <i class="fa fa-list"></i>
                    <span>Stamp History</span>
                    <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                </a>
                <ul class="treeview-menu">
                    <li class="<?php echo e(in_array(\Request::route()->getName(), ["admin.Orders.histroy"]) ? "active" : ""); ?>">
                        <a href="<?php echo e(route('admin.Orders.histroy')); ?>"><i class="fa fa-circle-o"></i> Stamp History List</a>
                    </li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li class="<?php echo e(in_array(\Request::route()->getName(), ["admin.Orders.index"]) ? "active" : ""); ?>">
                        <a href="<?php echo e(route('admin.Orders.index')); ?>"><i class="fa fa-circle-o"></i> Sales List</a>
                    </li>
            ...
            <li class="treeview <?php echo e(in_array(\Request::route()->getName(), ["admin.Orders.notification"]) ? "active" : ""); ?>">
                <a href="#">
                    <i class="fa fa-list"></i>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li class="<?php echo e(in_array(\Request::route()->getName(), ["admin.Orders.notification"]) ? "active" : ""); ?>">
                        <a href="<?php echo e(route('admin.Orders.notification')); ?>"><i class="fa fa-circle-o"></i> Send Notification</a>
                    </li>
            ...
            <li class="treeview <?php echo e(in_array(\Request::route()->getName(), ["admin.hooks","admin.add-hooks","admin.edit-hooks","admin.view-hooks","admin.email-preferences.index","admin.email-preferences.create","admin.email-preferences.edit","admin.email-preferences.show", "admin.email-templates.index","admin.email-templates.create","admin.email-templates.edit","admin.email-templates.show"]) ? "active" : ""); ?>">
            ...
            </li><li class="treeview <?php echo e(in_array(\Request::route()->getName(), ["admin.pages.index"]) ? "active" : ""); ?>">
                <a href="#">
                    <i class="fa fa-th"></i>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li class="<?php echo e(in_array(\Request::route()->getName(), ["admin.pages.index"]) ? "active" : ""); ?>">
